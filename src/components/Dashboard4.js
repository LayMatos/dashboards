...
const MapChart = () => {
 ...
 const handleGroupClick = (cor) => {
  ...
  return (
    ...
    >
      {/* Gráficos e Mapa Responsivos */}
     
<div style={{flexDirection:"column"}}>
    <div className="pizzaCharts" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <h4>Gráfico de Pizza</h4>
            <PieChart width={300} height={300}>
              <Pie data={selectedData.pizza} dataKey="value" outerRadius={100} fill="#8884d8">
      ...
      {/* Mapa */}
      <div className="mapWrapper" style={{ display: 'flex', justifyContent: 'center' }}>
        <ComposableMap
      ...
      <div className="barCharts" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', backgroundColor:"red" }}>
        ...
        <BarChart width={500} height={250} data={selectedData.barra}>
          <XAxis dataKey="name" />
          <YAxis />
          <Tooltip />
          <Legend />
